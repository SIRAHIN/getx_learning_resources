...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4281863515),
    value: Color(4281863515),
    light: ColorFamily(
      color: Color(4285551241),
      onColor: Color(4294967295),
      colorContainer: Color(4294040319),
      onColorContainer: Color(4280880193),
    ),
    ...
    dark: ColorFamily(
      color: Color(4292655608),
      onColor: Color(4282327896),
      colorContainer: Color(4283906672),
      onColorContainer: Color(4294040319),
    ),
